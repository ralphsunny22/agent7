...
<template>
    <div class="form-group mb-3">
        ...
        <input type="email" id="email" class="reg-input form-control" placeholder="e.g example@email.com" autocomplete="false" v-model="input" @keyup="validateInput" @blur="validateInput"
